                ...
                <div class="card-body card-block">
                    <form action="atualiza_aluno.php?ra=<?php echo $ra; ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="tel" value= "<?php echo $linha['tel']; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="dataNascimento" value= "<?php echo $linha['dataNascimento']; ?>" class="form-control">
                            </div>
                        </div>
